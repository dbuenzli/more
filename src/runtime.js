...
//Provides: ocaml_more_monotonic_now_ns
...
function ocaml_more_monotonic_now_ns () {
...
//Provides: ocaml_more_openpty
//Requires: caml_raise_sys_error
function ocaml_more_openpty (unit)
{
  caml_raise_sys_error ("ocaml_more_openpty is not available");
}

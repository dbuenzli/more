...
(** Monotonic time stamps and spans.
    ...
    To obtain and measure monotonic time use {!More.Os.Mtime}.

    @canonical More.Mtime *)
...
(** {1:timestamps Timestamps}
    ...
    correlation, otherwise prefer {!More.Os.Mtime.elapsed} and
    {{!More.Os.Mtime.monotonic_counters}counters} to measure
    time. *)

...
val paths : ?slip:string -> More__filepath.t list -> t
...
(** The type for tool search functions.
    ...
    See {!More.Os.Cmd.section-tool_search}
    for implementations. *)

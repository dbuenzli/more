...
module Path : sig
  ...
  val exists : More__fpath.t -> (bool, string) result
  ...
  val must_exist : More__fpath.t -> (unit, string) result
  ...
  val delete : recurse:bool -> More__fpath.t -> (bool, string) result
  ...
  val rename :
    More__fpath.t -> force:bool -> make_path:bool -> dst:More__fpath.t ->
    (unit, string) result
  ...
  val realpath : More__fpath.t -> (More__fpath.t, string) result
  ...
  val exists_realpath : More__fpath.t -> (More__fpath.t option, string) result
  ...
  val copy :
    ...
    ?stat_error:(More__fpath.t -> Unix.error -> unit) ->
    ?prune:(Unix.stats -> string -> More__fpath.t -> bool) ->
    follow_symlinks:bool -> recurse:bool -> More__fpath.t ->
    force:bool -> make_path:bool -> dst:More__fpath.t -> (unit, string) result
  ...
  val get_mode : More__fpath.t -> (int, string) result
  (** [get_mode p] is the file mode of [p]. Symbolic links are followed. *)

  val set_mode : More__fpath.t -> int -> (unit, string) result
  (** [set_mode file p] sets the file mode of [file] to [p]. Symbolic
      links are followed. *)

  val stat : More__fpath.t -> (Unix.stats, string) result
  ...
  val exists_stat : More__fpath.t -> (Unix.stats option, string) result
  ...
  val is_mount_point : More__fpath.t -> (bool, string) result
  ...
  val symlink :
    src:More__fpath.t -> force:bool -> make_path:bool -> More__fpath.t ->
    (unit, string) result
  ...
  val symlink_link : More__fpath.t -> (More__fpath.t, string) result
  (** [symlink_link p] is [Ok l] if [p] is a symbolic link to [l]. *)

  val symlink_stat : More__fpath.t -> (Unix.stats, string) result
  ...
  val tmp :
    ?make_path:bool -> ?dir:More__fpath.t -> ?name:tmp_name -> unit ->
    (More__fpath.t, string) result
...
module File : sig
  ...
  val is_executable : More__fpath.t -> bool
  ...
  val delete : More__fpath.t -> (bool, string) result
  ...
  val truncate : More__fpath.t -> int -> (unit, string) result
  (** [truncate file size] truncates [file] to [size]. *)

  (** {1:reads Reading} *)

  val read : More__fpath.t -> (string, string) result
  ...
  val read_with_fd :
    ?flags:Unix.open_flag list -> More__fpath.t ->
  ...
  val write :
    ...
    More__fpath.t -> string -> (unit, string) result
  ...
  val write_with_fd :
    ...
    make_path:bool -> More__fpath.t -> (Unix.file_descr -> ('a, 'b) result) ->
  ...
  val write_with_oc :
    ?flags:Unix.open_flag list -> ?atomic:bool -> ?mode:int -> force:bool ->
    make_path:bool -> More__fpath.t -> (out_channel -> ('a, 'b) result) ->
    (('a, 'b) result, string) result
  ...
  val copy :
    ?atomic:bool -> ?mode:int -> More__fpath.t ->
    force:bool -> make_path:bool -> dst:More__fpath.t -> (unit, string) result
  ...
  val with_tmp :
    ...
    ?dir:More__fpath.t -> ?name:Path.tmp_name -> (More__fpath.t -> 'a) ->
    ('a, string) result
  ...
  val with_tmp_fd :
    ?flags:Unix.open_flag list -> ?mode:int -> ?make_path:bool ->
    ?dir:More__fpath.t -> ?name:Path.tmp_name ->
    (More__fpath.t -> Unix.file_descr -> 'a) -> ('a, string) result
  ...
  val with_tmp_oc :
    ?flags:Unix.open_flag list -> ?mode:int -> ?make_path:bool ->
    ?dir:More__fpath.t -> ?name:Path.tmp_name ->
    (More__fpath.t -> out_channel -> 'a) -> ('a, string) result
  (** [with_tmp_oc] is like {!with_tmp_fd} but uses an OCaml output channel
      instead of a file decriptor. *)

  val open_tmp_fd :
    ?flags:Unix.open_flag list -> ?mode:int -> ?make_path:bool ->
    ?dir:More__fpath.t -> ?name:Path.tmp_name -> unit ->
    (More__fpath.t * Unix.file_descr, string) result
...
module Dir : sig
  ...
  val create :
    ?mode:int -> make_path:bool -> More__fpath.t -> (bool, string) result
  ...
  val fold :
    ?rel:bool ->
    ?stat_error:(More__fpath.t -> Unix.error -> unit) ->
    ?prune_dir:(Unix.stats -> string -> More__fpath.t -> 'a -> bool) ->
    dotfiles:bool -> follow_symlinks:bool -> recurse:bool ->
    (Unix.stats -> string -> More__fpath.t -> 'a -> 'a) ->
    More__fpath.t -> 'a -> ('a, string) result
  ...
  val fold_files :
    ...
    recurse:bool -> (Unix.stats -> string -> More__fpath.t -> 'a -> 'a) ->
    More__fpath.t -> 'a -> ('a, string) result
  (** [fold_files] is like {!fold} but [f] is only applied to
      non-directory files. *)

  val fold_dirs :
    ?rel:bool -> ?stat_error:(More__fpath.t -> Unix.error -> unit) ->
    ?prune_dir:(Unix.stats -> string -> More__fpath.t -> 'a -> bool) ->
    dotfiles:bool -> follow_symlinks:bool ->
    recurse:bool -> (Unix.stats -> string -> More__fpath.t -> 'a -> 'a) ->
    More__fpath.t -> 'a -> ('a, string) result
  ...
  val contents :
    ...
    ?rel:bool ->
    ?stat_error:(More__fpath.t -> Unix.error -> unit) ->
    ?prune_dir:(Unix.stats -> string -> More__fpath.t -> More__fpath.t list ->
                bool) ->
    dotfiles:bool -> follow_symlinks:bool ->
    recurse:bool -> More__fpath.t -> (More__fpath.t list, string) result
  ...
  val path_list :
    Unix.stats -> string -> More__fpath.t -> More__fpath.t list ->
    More__fpath.t list
  ...
  val warn_and_prune_denied :
    dir:More__fpath.t -> rel:bool ->
    (Unix.stats -> string -> More__fpath.t -> 'a -> bool)
  ...
  val warn_stat_error : More__fpath.t -> Unix.error -> unit
  ...
  val copy :
    ...
    ?stat_error:(More__fpath.t -> Unix.error -> unit) ->
    ?prune:(Unix.stats -> string -> More__fpath.t -> bool) ->
    follow_symlinks:bool -> make_path:bool -> More__fpath.t ->
    dst:More__fpath.t -> (unit, string) result
  ...
  val default_tmp : unit -> More__fpath.t
  ...
  val set_default_tmp : More__fpath.t -> unit
  ...
  val with_tmp :
    ?mode:int -> ?make_path:bool -> ?dir:More__fpath.t -> ?name:Path.tmp_name ->
    (More__fpath.t -> 'a) -> ('a, string) result
  ...
  val tmp :
    ?mode:int -> ?make_path:bool -> ?dir:More__fpath.t -> ?name:Path.tmp_name ->
    unit -> (More__fpath.t, string) result
  ...
  val user : unit -> (More__fpath.t, string) result
  ...
  val config : unit -> (More__fpath.t, string) result
  ...
  val data : unit -> (More__fpath.t, string) result
  ...
  val cache : unit -> (More__fpath.t, string) result
  ...
  val runtime : unit -> (More__fpath.t, string) result
  ...
  val state : unit -> (More__fpath.t, string) result
...
module Socket : sig
  ...
  (** {1:endpoints Endpoint}
      ...
      {b TODO.} We'd like to have this in {!More.Net.Endpoint} but
      we need to restructure the sources. *)

  val endpoint_wait_connectable :
    ?socket_type:Unix.socket_type -> timeout:More__mtime.Span.t ->
    More__net.Endpoint.t ->
  ...
  val endpoint_wait_connectable' :
    ?socket_type:Unix.socket_type -> timeout:More__mtime.Span.t ->
    More__net.Endpoint.t -> (unit, string) result
  ...
  val for_endpoint :
    ?nonblock:bool -> More__net.Endpoint.t -> Unix.socket_type ->
  ...
  val listen_endpoint :
    ?nonblock:bool -> ?backlog:int -> More__net.Endpoint.t ->
...
module Env : sig
  ...
  (** [of_assignments ~init ss] folds over strings in [ss],
      {{!More.String.cut}cuts} them at the leftmost ['='] character and
...
module Cmd : sig
  ...
  val path_search :
    ?win_exe:bool -> ?path:More__fpath.t list -> unit -> More__cmd.tool_search
  ...
  val in_file : More__fpath.t -> stdi
  ...
  val out_file :
    ?mode:int -> force:bool -> make_path:bool -> More__fpath.t -> stdo
  ...
  val run_status :
    ?env:Env.assignments -> ?cwd:More__fpath.t -> ?stdin:stdi -> ?stdout:stdo ->
    ?stderr:stdo -> More__cmd.t -> (status, string) result
  ...
  val run_status_out :
    ?env:Env.assignments -> ?cwd:More__fpath.t -> ?stdin:stdi ->
  ...
  val execv :
    ?env:Env.assignments -> ?cwd:More__fpath.t -> ?argv0:string ->
...
module Exit : sig
  ...
  val execv_cwd : execv -> More__fpath.t option
  (** [execv_env exec] is the environment of [exec]. *)
...
*)
  ...
  val open_with_spawn :
    ?env:Env.assignments -> ?cwd:More__fpath.t -> ?stdin:Cmd.stdi ->

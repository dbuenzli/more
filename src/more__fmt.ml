...
let bigbytes ppf v =
  ...
  begin
    ...
    char ppf (More__char.Ascii.lower_hex_digit_of_int (byte lsr 4));
    char ppf (More__char.Ascii.lower_hex_digit_of_int byte);
    for i = 1 to max do

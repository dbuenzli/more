...
let file = Filepath.v "file"
let file_sym = Filepath.v "file_sym"
let dang_file_sym = Filepath.v "dang_file_sym"
let dir = Filepath.v "dir"
let dir_sym = Filepath.v "dir_sym"
let dang_dir_sym = Filepath.v "dang_dir_sym"
let dir_ne = Filepath.v "dir_ne"
let dir_ne_sym = Filepath.v "dir_ne_sym"
...
let setup_fs tmp =
  ...
  let* () = Os.File.write ~force ~make_path (Filepath.(dir_ne / "ha")) "ho" in
